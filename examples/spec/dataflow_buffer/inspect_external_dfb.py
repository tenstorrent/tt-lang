...
INSPECT_DFB_HEADER = str(Path(__file__).with_name("inspect_external_dfb.hpp"))


@ttl.operation(grid=(1, 1))
def inspect_external_dfb(input_tensor, output_tensor):
...
try:
    ...
    inspect_external_dfb(input_tensor, output_tensor)
