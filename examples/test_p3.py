...
def p3(Q, K, out, block_factors=None, grid=None):
    """Full softmax: matmul + rowmax + subtract + exp + rowsum"""
...
p3(torch.randn(32, 32), torch.randn(32, 32), torch.zeros(32, 32))
print('✓ Pattern 3: Full softmax works!')
