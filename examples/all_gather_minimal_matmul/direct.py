...
"""Direct-style fabric all-gather fused with a block matmul.
...
This example models the all-gather and local-N-sharded matmul core. It does not
model tt-metal optional bias, fused activation, addcmul, SwiGLU, chunked
outputs, FSDP weight gather, or program-factory core-grid scheduling.
"""
...
def main() -> None:
    ...
    print_config("all_gather_minimal_matmul_direct", config)
