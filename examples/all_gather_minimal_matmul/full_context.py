...
"""Full context-manager fabric all-gather fused with a block matmul.
...
The smaller `context.py` variant remains the stable baseline.
"""
...
def main() -> None:
    ...
    print_full_config("all_gather_minimal_matmul_full_context", config)
