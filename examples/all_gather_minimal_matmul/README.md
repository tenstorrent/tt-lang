...
The dated branch `integration/demo-20260730` is the local demo revision. The
demo checkout is `/home/bnorris/tt/tt-lang4`, and the validated container is
`bnorris-ird-fabric-v1.1.7`.

Build the demo branch:

```bash
cd /home/bnorris/tt/tt-lang4
