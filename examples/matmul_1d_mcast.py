...
def matmul_1d(
    ...
    read_tiles = granularity_k * granularity_n * Mb * Kb * Nb + granularity_m * granularity_k * Mb * Kb * nb_per_core
    write_tiles = (granularity_n * granularity_m) * Mb * Nb
    print("(Reads {0} tiles, writes {1} tiles) ".format(read_tiles, write_tiles), end="")
