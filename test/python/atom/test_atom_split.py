...
def test_composition_preserves_interface_preserved_dfb_access():
    ...
    def descriptor_helper(descriptor: ttl.DFB):
        ttl.call_extern_func(
            ...
            dfb_accesses=[ttl.DFBAccess.interface_preserved(descriptor)],
            kernel=(ttl.KernelKind.COMPUTE, ttl.KernelKind.DATA_MOVEMENT),
        )
    ...
    for source in (
        ...
        assert source.count("ttl.DFBAccess.interface_preserved(descriptor)") == 1
