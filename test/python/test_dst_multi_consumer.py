...
def unary_binary_kernel(x, y, out):
    ...
    x_dfb = ttl.make_circular_buffer_like(x, shape=(1, 1), buffer_factor=2)
    y_dfb = ttl.make_circular_buffer_like(y, shape=(1, 1), buffer_factor=2)
    out_dfb = ttl.make_circular_buffer_like(out, shape=(1, 1), buffer_factor=2)
...
def three_consumers_kernel(a, b, out_sig, out_exp, out_add):
    ...
    sig_dfb = ttl.make_circular_buffer_like(out_sig, shape=(1, 1), buffer_factor=2)
    exp_dfb = ttl.make_circular_buffer_like(out_exp, shape=(1, 1), buffer_factor=2)
    add_dfb = ttl.make_circular_buffer_like(out_add, shape=(1, 1), buffer_factor=2)
