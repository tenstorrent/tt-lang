...
# =============================================================================
# DIAGNOSTIC: DRAM without explicit push (matches working L1 pattern)
# =============================================================================
# The working test_runtime_add.py does NOT call push() in DM threads.
# This test uses DRAM TensorAccessor but follows the same no-push pattern.
# =============================================================================
...
def test_diag_dram_nopush(lhs, rhs, out):
...
print("=== DIAG: DRAM no push (matches L1 pattern) ===")
test_diag_dram_nopush(lhs, rhs, out)
print(f"Result: {out[0,0].item()} (may be garbage, but didn't hang)")
print("DONE")
