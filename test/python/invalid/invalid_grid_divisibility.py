...
"""
Validation test: tensor shape must be divisible by grid dimensions.

This test verifies that using a shape not divisible by grid raises ValueError.
Uses grid=(2, 3) with shape=(32, 32) - 32 is not divisible by 3.
"""
...
if __name__ == "__main__":
    ...
    print("=== Grid Divisibility Validation Test ===")

    device = ttnn.open_device(device_id=0)

    try:
        # 32x32 tensor with grid (2, 3) - 32 % 3 != 0
        ...
        invalid_divisibility_kernel(lhs, rhs, out)
