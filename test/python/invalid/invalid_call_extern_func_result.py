...
def invalid_external_result(inp):
    @ttl.compute()
    def compute():
        # CHECK: TTLangCompileError: error: ttl.call_extern_func() got unexpected keyword argument(s): results.
