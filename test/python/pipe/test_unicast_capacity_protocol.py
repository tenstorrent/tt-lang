...
def _capacity_loop_op(recv_block_count):
...
def test_unicast_dataflow_capacity_loop(device, dtype, rtol, atol, recv_block_count):
    ...
    _capacity_loop_op(recv_block_count)(inp, out)
