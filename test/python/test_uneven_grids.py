...
def multitile_uneven_kernel(lhs, rhs, out):
    ...
    lhs_dfb = ttl.make_circular_buffer_like(lhs, shape=(CB_ROWS, CB_COLS), buffer_factor=2)
    rhs_dfb = ttl.make_circular_buffer_like(rhs, shape=(CB_ROWS, CB_COLS), buffer_factor=2)
    out_dfb = ttl.make_circular_buffer_like(out, shape=(CB_ROWS, CB_COLS), buffer_factor=2)
