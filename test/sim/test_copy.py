...
from ttl.sim.blockstate import BlockAcquisition, ThreadType
...
from ttl.sim.copy import CopyTransaction, GroupTransfer, copy
...
class TestCopyErrorConditions:
    ...
    def test_copy_creates_transaction_immediately(self) -> None:
        ...
        from ttl.sim.copy import copy, CopyTransaction
