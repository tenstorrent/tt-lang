...
from ttl.sim import TILE_SHAPE, copy, ttnn
from ttl.sim.ttnnsim import ROW_MAJOR_LAYOUT, TILE_LAYOUT, Tensor
from ttl.sim.dfb import (
    Block,
    DataflowBuffer,
    make_dataflow_buffer_like,
)
from ttl.sim.math import broadcast
from ttl.sim.blockstate import (
    ThreadType,
    BlockAcquisition,
)
...
def test_reserve_store_push_pop_workflow() -> None:
    ...
    import torch
    from ttl.sim import ttnn, TILE_SHAPE
...
def test_pending_confirmation_cleared_when_result_is_stored() -> None:
    ...
    from ttl.sim.context import set_current_thread_type, clear_current_thread_type
    from ttl.sim.copy import copy as dm_copy
...
def test_per_core_dfb_limit_exceeds_max() -> None:
    ...
    from ttl.sim import ttl
    from ttl.sim.program import set_max_dfbs
...
def test_1d_tile_count_from_tensor():
    ...
    from ttl.sim.dfb import tile_count_from_tensor
