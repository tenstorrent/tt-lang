...
module {
  ...
  func.func @test_dma_ops(%arg0: tensor<32x32xf32> {d2m.stream = true}, %arg1: tensor<32x32xf32> {d2m.stream = false}, %arg2: tensor<32x32xf32> {d2m.stream = false}) -> tensor<32x32xf32> {
