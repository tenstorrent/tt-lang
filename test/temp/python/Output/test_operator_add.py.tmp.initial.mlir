...
module {
  func.func @test_add(%arg0: tensor<32x32xf32> {d2m.stream = false}, %arg1: tensor<32x32xf32> {d2m.stream = false}, %arg2: tensor<32x32xf32> {d2m.stream = false}) -> tensor<32x32xf32> {
