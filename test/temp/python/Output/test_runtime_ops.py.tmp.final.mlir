...
module attributes {ttcore.system_desc = #system_desc} {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      func.func @test_runtime_ops(%arg0: memref<32x32xf32> {d2m.stream = true}, %arg1: memref<32x32xf32> {d2m.stream = true}, %arg2: memref<32x32xf32> {d2m.stream = false}) -> memref<32x32xf32> {
        ...
        %2 = "ttmetal.create_buffer"() <{address = 105248 : i64}> : () -> memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
        %3 = "ttmetal.create_buffer"() <{address = 117536 : i64}> : () -> memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
        ...
        %6 = "ttmetal.create_buffer"() <{address = 101152 : i64}> : () -> memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
        ...
        %7 = "ttmetal.create_buffer"() <{address = 105248 : i64}> : () -> memref<1x1x32x32xf32, #ttcore.shard<128x4>, #l1>
