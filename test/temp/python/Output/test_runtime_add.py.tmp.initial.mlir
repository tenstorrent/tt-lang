...
module {
  ...
  ttcore.global @rhs = tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout> [1]
  func.func @test_runtime_add(%arg0: tensor<32x32xf32> {d2m.stream = true}, %arg1: tensor<32x32xf32> {d2m.stream = true}, %arg2: tensor<32x32xf32> {d2m.stream = false}) -> tensor<32x32xf32> {
    ...
    %7 = d2m.generic {block_factors = [], grid = #ttcore.grid<1x1>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
        ins(%stream, %stream_0 : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>, tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>)
        outs(%6 : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>)  {
    ^datamovement0(%cb0: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb1: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb2: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>):
      %9 = ttcore.get_global @lhs : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>
      %10 = d2m.reserve %cb0 : <tensor<1x1x!ttcore.tile<32x32, f32>>> -> tensor<1x1x!ttcore.tile<32x32, f32>>
      %c0 = arith.constant 0 : index
      %c0_1 = arith.constant 0 : index
      %tx = d2m.dma %9 [%c0, %c0_1], %10 : (tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !d2m.mem_tx
      d2m.dma_wait %tx
    }, {
    ^datamovement1(%cb0: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb1: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb2: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>):
      %9 = ttcore.get_global @rhs : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>
    ...
    ^compute0(%cb0: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb1: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>, %cb2: !d2m.cb<tensor<1x1x!ttcore.tile<32x32, f32>>>):
      ...
      %10 = d2m.wait %cb1 : <tensor<1x1x!ttcore.tile<32x32, f32>>> -> tensor<1x1x!ttcore.tile<32x32, f32>>
      %11 = d2m.reserve %cb2 : <tensor<1x1x!ttcore.tile<32x32, f32>>> -> tensor<1x1x!ttcore.tile<32x32, f32>>
      %12 = d2m.empty() : tensor<1x1x!ttcore.tile<32x32, f32>>
      %13 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%9, %10 : tensor<1x1x!ttcore.tile<32x32, f32>>, tensor<1x1x!ttcore.tile<32x32, f32>>) outs(%12 : tensor<1x1x!ttcore.tile<32x32, f32>>) {
      ^bb0(%in: !ttcore.tile<32x32, f32>, %in_1: !ttcore.tile<32x32, f32>, %out: !ttcore.tile<32x32, f32>):
        %15 = "d2m.tile_add"(%in, %in_1) : (!ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>) -> !ttcore.tile<32x32, f32>
        linalg.yield %15 : !ttcore.tile<32x32, f32>
      } -> tensor<1x1x!ttcore.tile<32x32, f32>>
      d2m.store %11, %13 : tensor<1x1x!ttcore.tile<32x32, f32>>
    ...
    %8 = d2m.to_layout %7, %arg2 : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout> into tensor<32x32xf32> -> tensor<32x32xf32>
