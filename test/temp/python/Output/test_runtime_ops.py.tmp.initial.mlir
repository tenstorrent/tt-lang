...
module {
  ...
  func.func @test_runtime_ops(%arg0: tensor<32x32xf32> {d2m.stream = true}, %arg1: tensor<32x32xf32> {d2m.stream = true}, %arg2: tensor<32x32xf32> {d2m.stream = false}) -> tensor<32x32xf32> {
