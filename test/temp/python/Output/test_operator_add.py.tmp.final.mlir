...
module attributes {ttcore.system_desc = #system_desc} {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      func.func @test_add(%arg0: memref<32x32xf32> {d2m.stream = false}, %arg1: memref<32x32xf32> {d2m.stream = false}, %arg2: memref<32x32xf32> {d2m.stream = false}) -> memref<32x32xf32> {
