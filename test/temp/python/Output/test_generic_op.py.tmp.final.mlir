...
module attributes {ttcore.system_desc = #system_desc} {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      func.func @test_generic(%arg0: memref<64x64xf32> {d2m.stream = false}, %arg1: memref<64x64xf32> {d2m.stream = false}, %arg2: memref<64x64xf32> {d2m.stream = false}) -> memref<64x64xf32> {
        %0 = "ttmetal.create_buffer"() <{address = 113440 : i64}> : () -> memref<2x2x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
        ...
        %2 = "ttmetal.create_buffer"() <{address = 109344 : i64}> : () -> memref<2x2x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
        %3 = "ttmetal.create_buffer"() <{address = 101152 : i64}> : () -> memref<2x2x32x32xf32, #ttcore.shard<128x4>, #l1>
        ...
        %4 = "ttmetal.create_buffer"() <{address = 105248 : i64}> : () -> memref<2x2x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1>
