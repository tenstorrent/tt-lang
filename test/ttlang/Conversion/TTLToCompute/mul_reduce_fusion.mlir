// Verifies SumOfSquares selection and end-to-end lowering through one fixed
// multiply/full-scalar-reduction schedule without an intermediate DFB.
...
// PLAN:           resources dst=7/8 acquisitions=1 eliminated-intermediate-dfb-bytes=16384
// PLAN:       order=[C0]

// Creation emits one fixed block and allocates no compiler intermediate DFB.
// COMPUTE-LABEL: func.func @sum_of_squares
// COMPUTE-NOT:   ttl.bind_cb{{.*}}ttl.compiler_allocated
// COMPUTE:       ttl.compute
// COMPUTE:         ttl.tile_mul_reduce_block
