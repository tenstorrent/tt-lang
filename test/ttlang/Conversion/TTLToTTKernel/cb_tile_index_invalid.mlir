...
// Tests for computeCBTileIndex validation in convert-ttl-to-ttkernel.
...
// Loops must be annotated with ttl.tile_loop_stride or ttl.subblock_loop_stride to be
// recognized by computeCBTileIndex.

// -----

// Dynamic upper bound: tile_store inside a marked tile loop with dynamic UB.
// computeCBTileIndex rejects this because it expects constant bounds.
...
// computeCBTileIndex requires all tile loops to start at 0.
...
// computeCBTileIndex requires constant step for subblock loops.
...
// computeCBTileIndex requires constant lower bounds.
