...
// comparisons through the full --convert-ttl-to-ttkernel + --ttl-lower-scalar-fp-types
// pipeline. Covers ogt/olt for f32 and bf16, comparisons against constants,
// and comparisons within loops.
// RUN: ttlang-opt --convert-ttl-to-ttkernel --ttl-lower-scalar-fp-types --canonicalize -cse --split-input-file %s | FileCheck %s
