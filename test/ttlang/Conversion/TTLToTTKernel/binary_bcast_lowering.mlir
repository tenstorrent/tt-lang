...
// reading both operands from CBs, plus input format reconfiguration
// and a binary_bcast_init carrying the elementwise op and the broadcast
// dimension. Neither unary_bcast nor copy_tile should appear: the broadcast is
// applied during unpack rather than materialized into DST.
