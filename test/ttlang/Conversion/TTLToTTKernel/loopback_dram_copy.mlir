...
// TTKERNEL:   ttkernel.noc_async_read_tile({{.*}}, %[[ACC_R]], %[[CB_W_PTR]], %[[NOC]]) : (i32, !ttkernel.TensorAccessor, i32, i8) -> ()
...
// TTKERNEL:   ttkernel.noc_async_write_tile({{.*}}, %[[ACC_W]], %[[CB_R_PTR]], %[[NOC]]) : (i32, !ttkernel.TensorAccessor, i32, i8) -> ()
