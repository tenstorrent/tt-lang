...
// CPP: describe<ttlang::l1::DFBDescriptor<2048, 1, 2, 2, 8, 12344, -1>>();
module attributes {ttl.memory_model = "compiler-sram", ttl.l1_arena_bytes = 16448 : i64, ttl.target_arch = #ttcore.arch<wormhole_b0>, ttl.dfb_allocations = [
  {block_count = 2 : i32, dfb_index = 0 : i32, element_type = !ttcore.tile<32x32, bf16>, l1_allocation_bytes = 4096 : i64, l1_offset = 0 : i64, l1_payload_offset = 64 : i64, num_tiles = 1 : i32, page_size = 2048 : i32, storage_index = 0 : i32, storage_capacity_pages = 2 : i32},
  {block_count = 2 : i32, dfb_index = 1 : i32, element_type = !ttcore.tile<32x32, bf16>, l1_allocation_bytes = 4096 : i64, l1_offset = 8 : i64, l1_payload_offset = 12352 : i64, num_tiles = 1 : i32, page_size = 2048 : i32, storage_index = 1 : i32, storage_capacity_pages = 2 : i32}
]} {
