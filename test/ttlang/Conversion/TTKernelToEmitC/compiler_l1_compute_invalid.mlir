...
// expected-error @below {{'builtin.module' op compiler-l1 allocation entry 0 must define positive uint32 page_size, num_tiles, and block_count values and representable ordered L1 offsets}}
module attributes {ttl.memory_model = "compiler-l1", ttl.dfb_allocations = [{block_count = 1 : i64, l1_offset = 64 : i64, l1_payload_offset = 32 : i64, num_tiles = 1 : i64, page_size = 2048 : i64}]} {
...
module attributes {ttl.memory_model = "compiler-l1", ttl.dfb_allocations = [{block_count = 1 : i64, element_type = !ttcore.tile<32x32, bf16>, l1_offset = 0 : i64, l1_payload_offset = 64 : i64, num_tiles = 1 : i64, page_size = 2048 : i64}]} {
...
module attributes {ttl.memory_model = "compiler-l1", ttl.dfb_allocations = [{cb_index = 0 : i64, page_size = 2048 : i64, num_tiles = 2 : i64, block_count = 1 : i64, l1_offset = 0 : i64, l1_payload_offset = 64 : i64}]} {
  func.func @partial_block() attributes {ttkernel.thread = #ttkernel.thread<compute>} {
    ...
    // expected-error @below {{compiler-l1 requires full-block synchronization to preserve contiguous acquisitions}}
