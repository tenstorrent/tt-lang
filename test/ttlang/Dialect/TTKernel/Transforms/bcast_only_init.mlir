// Summary: Unary broadcast uses the short init and preserves DST bank state.
...
// CHECK-NEXT: ttkernel.reconfig_data_format(%[[IN_CB]], %[[IN_CB]])
// CHECK-NEXT: ttkernel.unary_bcast_init(%[[IN_CB]], <col>)
