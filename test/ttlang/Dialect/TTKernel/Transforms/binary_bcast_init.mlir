...
// CBs, the output CB resolved from ttl.bcast_output_cb_index, and both the
// elementwise op and the broadcast dimension. Consecutive ops sharing all of
// those reuse one init; changing either attribute forces a re-init.
...
// CHECK: ttkernel.binary_bcast_init(%[[IN0]], %[[IN1]], %[[OUT]], <add>, <col>)
