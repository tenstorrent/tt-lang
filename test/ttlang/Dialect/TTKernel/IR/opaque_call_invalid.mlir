...
func.func @block_arg_template_arg(%arg0: i32) {
  // expected-error @below {{'ttkernel.opaque_call' op template arg must be a compile-time evaluable value (arith.constant, ttkernel.get_dfb_id, or ttkernel.get_semaphore), got a block argument}}
...
func.func @runtime_template_arg(%arg0: i32) {
  ...
  // expected-error @below {{'ttkernel.opaque_call' op template arg must be a compile-time evaluable value (arith.constant, ttkernel.get_dfb_id, or ttkernel.get_semaphore), got 'arith.addi'}}
