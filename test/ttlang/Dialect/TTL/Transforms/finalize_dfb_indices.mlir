...
func.func @scalar_page_sizes()
  ...
  %i8 = ttl.bind_cb {cb_index = 0, block_count = 2} {dfb_id = 0 : index}
      : !ttl.cb<[128], i8, 2>
  %i24 = ttl.bind_cb {cb_index = 1, block_count = 2} {dfb_id = 1 : index}
      : !ttl.cb<[64], i24, 2>
