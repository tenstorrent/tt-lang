...
// RUN: ttlang-opt %s --split-input-file -pass-pipeline='builtin.module(ttl-finalize-dfb-indices)' | FileCheck %s --check-prefixes=COMPACT-GAP,COMPACT-NOZERO,COMPACT-GAP-COMMON,COMPACT-NOZERO-COMMON
// RUN: ttlang-opt %s --split-input-file -pass-pipeline='builtin.module(ttl-finalize-dfb-indices{reuse-user-dfbs=false})' | FileCheck %s --check-prefixes=COMPACT-GAP-NOREUSE,COMPACT-NOZERO-NOREUSE,COMPACT-GAP-COMMON,COMPACT-NOZERO-COMMON
...
// COMPACT-GAP-COMMON-LABEL: func.func @compact_middle_gap
// COMPACT-GAP-COMMON-SAME: ttl.base_cta_index = 2 : i32
// COMPACT-GAP-COMMON-DAG: ttl.bind_cb{cb_index = 0, block_count = 2} {dfb_id = 0 : index}
// COMPACT-GAP-COMMON-DAG: ttl.bind_cb{cb_index = 1, block_count = 2} {dfb_id = 2 : index}
...
// COMPACT-NOZERO-COMMON-LABEL: func.func @compact_missing_zero
// COMPACT-NOZERO-COMMON-SAME: ttl.base_cta_index = 2 : i32
// COMPACT-NOZERO-COMMON-DAG: ttl.bind_cb{cb_index = 0, block_count = 2} {dfb_id = 1 : index}
// COMPACT-NOZERO-COMMON-DAG: ttl.bind_cb{cb_index = 1, block_count = 2} {dfb_id = 2 : index}
