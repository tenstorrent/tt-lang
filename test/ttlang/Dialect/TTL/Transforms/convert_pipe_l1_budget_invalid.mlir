...
// expected-error @below {{combined DFB and runtime resources require 12352 L1 bytes but the budget is 12351 (DFB=12288, scratch=0, global semaphores=64, reconfiguration state=0)}}
