...
// RUN: ttlang-opt %s --pass-pipeline='builtin.module(func.func(convert-ttl-to-compute,ttl-mark-fpu-binaries,ttl-set-compute-kernel-config, ttl-assign-dst,ttl-subblock-compute-for-dst),canonicalize,cse)' | FileCheck %s --check-prefix=SUBBLOCK
