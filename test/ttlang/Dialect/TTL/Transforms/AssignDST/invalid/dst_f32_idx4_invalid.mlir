...
// RUN: ttlang-opt %s -pass-pipeline='builtin.module(func.func(ttl-lower-binary-tiles, ttl-assign-dst))' --verify-diagnostics
...
func.func @f32_capacity_overflow(%a: tensor<2x2x!ttcore.tile<32x32, f32>>,
  ...
  %cbout = ttl.bind_cb {cb_index = 16, block_count = 2} : !ttl.cb<[2, 2], !ttcore.tile<32x32, f32>, 2>
