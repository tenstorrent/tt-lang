...
// B is copied first (reverse order), then A copies interleaved with unary ops
...
// CHECK:       %[[ADD:.*]] = ttl.tile_add %[[A]], %{{.*}} {dst_idx = 0 : i32}
...
// All copies at top in reverse order: C, B, A
