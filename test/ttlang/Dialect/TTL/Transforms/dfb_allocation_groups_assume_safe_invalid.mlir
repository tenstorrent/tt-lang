// Tests strict mode and the structural errors retained by unsafe mode.
...
// Strict mode rejects an allocation group without a proven handoff.

module {
  func.func @strict_unproven_handoff()
