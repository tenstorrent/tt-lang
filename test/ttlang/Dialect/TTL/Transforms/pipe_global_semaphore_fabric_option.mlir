...
// The one-shot fabric transfer needs only its global completion counter.
...
// LOCAL-DAG: %[[LOCAL_FABRIC_DONE_INDEX:.*]] = arith.constant 0 : index
...
// LOCAL-NOT: ttkernel.experimental.semaphore_wait
...
// GLOBAL-NOT: ttkernel.experimental.semaphore_wait
