...
// RUN: ttlang-opt %s --split-input-file -pass-pipeline='builtin.module(ttl-finalize-dfb-indices{reuse-user-dfbs=true},func.func(ttl-set-compute-kernel-config))' | FileCheck %s --check-prefix=CONFIG
