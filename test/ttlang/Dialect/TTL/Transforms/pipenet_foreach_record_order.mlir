...
// CHECK: %[[LOWER:.*]] = ttkernel.experimental.constant_table_lookup {{.*}}, [0, 5] : index
// CHECK: %[[UPPER:.*]] = ttkernel.experimental.constant_table_lookup {{.*}}, [0, 5] : index
// CHECK: scf.for %[[MEMBERSHIP:.*]] = %[[LOWER]] to %[[UPPER]] step %[[ONE]] {
// CHECK: %[[RECORD:.*]] = ttkernel.experimental.constant_table_lookup %[[MEMBERSHIP]], [0, 1, 2, 3, 4] : index
