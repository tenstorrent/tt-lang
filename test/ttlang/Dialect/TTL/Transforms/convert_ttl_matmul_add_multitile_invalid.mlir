...
func.func @multi_matmul_multitile() attributes {ttl.kernel_thread = #ttkernel.thread<compute>} {
  %a1_cb = ttl.bind_cb{cb_index = 0, buffer_factor = 2} : <[4, 2], !ttcore.tile<32x32, bf16>, 2>
  %b1_cb = ttl.bind_cb{cb_index = 1, buffer_factor = 2} : <[2, 4], !ttcore.tile<32x32, bf16>, 2>
  %a2_cb = ttl.bind_cb{cb_index = 2, buffer_factor = 2} : <[4, 2], !ttcore.tile<32x32, bf16>, 2>
  %b2_cb = ttl.bind_cb{cb_index = 3, buffer_factor = 2} : <[2, 4], !ttcore.tile<32x32, bf16>, 2>
  %out_cb = ttl.bind_cb{cb_index = 4, buffer_factor = 2} : <[4, 4], !ttcore.tile<32x32, bf16>, 2>
