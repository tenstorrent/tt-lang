...
// CHECK: module attributes {ttl.dfb_allocations = [], ttl.launch_grid = array<i64: 2, 5>, ttl.pipe_sram_scratch_bytes = 32 : i64, ttl.pipe_sync_semaphore_count = 8 : i64}

module attributes {ttl.dfb_allocations = [], ttl.launch_grid = array<i64: 2, 5>} {
...
func.func @gather_receiver()
  ...
  %cb = ttl.bind_cb {cb_index = 1, block_count = 6} {dfb_id = 0 : index}
