// RUN: env TTL_RELAX_DFB_SPSC=1 ttlang-opt %s -ttl-verify-pipenet-guards --verify-diagnostics

// Relaxing DFB producer domains must not relax PipeNet endpoint guards.
