...
// fallback transfers in the same module still do. Transfers to disjoint
// receivers reuse completion semaphore 0, so the remaining sender-ready and
// capacity semaphores use ids 1 and 2.
