...
// A guarded reserve released in its own branch is free before a later
// sibling region reserves the buffer again; nothing is inserted.
...
func.func @guarded_release_before_sibling_region_acquisition(
    %arg0: tensor<1x1x!ttcore.tile<32x32, bf16>>, %first: i1, %second: i1)
    attributes {ttl.kernel_thread = #ttkernel.thread<compute>} {
  %dfb = ttl.bind_cb {cb_index = 0, block_count = 2} : !ttl.cb<[1, 1], !ttcore.tile<32x32, bf16>, 2>
