...
// DFB storage (24576), Pipe scratch (64), and boundary state (1088) each fit
// when checked separately, but their combined 25728-byte allocation does not.
// expected-error @below {{combined DFB, PipeNet, and reconfiguration resources require 25728 L1 bytes but the budget is 25727 (DFB=24576, pipe scratch=64, global semaphores=0, reconfiguration state=1088)}}
module attributes {
