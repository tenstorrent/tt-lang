...
// expected-error @below {{combined DFB and runtime resources require 25664 L1 bytes but the budget is 25663 (DFB=24576, scratch=32, global semaphores=0, reconfiguration state=1056)}}
