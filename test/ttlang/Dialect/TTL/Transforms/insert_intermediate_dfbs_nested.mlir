...
// RUN: ttlang-opt %s --split-input-file -pass-pipeline='builtin.module(ttl-insert-intermediate-dfbs,func.func(ttl-insert-cb-sync),ttl-finalize-dfb-indices)' | FileCheck %s
