...
// RUN: ttlang-opt %s -convert-ttl-to-ttkernel | FileCheck %s --implicit-check-not=ttkernel.get_semaphore

// Summary: Verify functions with multiple fabric manager intervals remain
// mutually interfering under the function-wide manager runtime ABI.

// Each callback has two manager intervals. Every interval reconstructs the
// function's complete connection set, so pair-local ownership cannot prove
// connection noninterference.
// CHECK-LABEL: module attributes
// CHECK-SAME: ttl.pipe_sync_semaphore_count = 0 : i64
// CHECK-LABEL: func.func @sender_node
// CHECK-SAME: ttl.fabric_manager_intervals = [#ttl.fabric_manager_interval<identity = "generated.0", kind = generated_sender, routeIndices = [0], interferingIntervals = "generated.1", "generated.2", "generated.3">, #ttl.fabric_manager_interval<identity = "generated.2", kind = generated_sender, routeIndices = [0], interferingIntervals = "generated.0", "generated.1", "generated.3">]
// CHECK-LABEL: func.func @receiver_node
// CHECK-SAME: ttl.fabric_manager_intervals = [#ttl.fabric_manager_interval<identity = "generated.1", kind = generated_receiver, routeIndices = [0], interferingIntervals = "generated.0", "generated.2", "generated.3">, #ttl.fabric_manager_interval<identity = "generated.3", kind = generated_receiver, routeIndices = [0], interferingIntervals = "generated.0", "generated.1", "generated.2">]
