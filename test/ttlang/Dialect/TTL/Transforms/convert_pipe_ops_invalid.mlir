...
// Seventeen PipeNets with completion counters on the same destination node
// cannot share an id, so they exceed the hardware semaphore namespace.
...
module {
  func.func @unicast_pipe_sync_exceeds_hardware_semaphore_limit()
    ...
    %pipe2 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 2 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 2>
    %pipe3 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 3 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 3>
    %pipe4 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 4 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 4>
    %pipe5 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 5 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 5>
    %pipe6 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 6 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 6>
    %pipe7 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 7 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 7>
    %pipe8 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 8 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 8>
    %pipe9 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 9 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 9>
    %pipe10 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 10 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 10>
    %pipe11 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 11 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 11>
    %pipe12 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 12 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 12>
    %pipe13 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 13 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 13>
    %pipe14 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 14 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 14>
    %pipe15 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 15 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 15>
    %pipe16 = ttl.create_pipe src(0, 0) dst(1, 0) to(1, 0) net 16 : !ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 16>

    %recv0 = ttl.cb_reserve %cb0 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post0 = ttl.copy %pipe0, %recv0 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 0>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post0 : !ttl.transfer_handle
    %recv1 = ttl.cb_reserve %cb1 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post1 = ttl.copy %pipe1, %recv1 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 1>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post1 : !ttl.transfer_handle
    %recv2 = ttl.cb_reserve %cb2 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post2 = ttl.copy %pipe2, %recv2 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 2>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post2 : !ttl.transfer_handle
    %recv3 = ttl.cb_reserve %cb3 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post3 = ttl.copy %pipe3, %recv3 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 3>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post3 : !ttl.transfer_handle
    %recv4 = ttl.cb_reserve %cb4 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post4 = ttl.copy %pipe4, %recv4 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 4>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post4 : !ttl.transfer_handle
    %recv5 = ttl.cb_reserve %cb5 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post5 = ttl.copy %pipe5, %recv5 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 5>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post5 : !ttl.transfer_handle
    %recv6 = ttl.cb_reserve %cb6 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post6 = ttl.copy %pipe6, %recv6 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 6>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post6 : !ttl.transfer_handle
    %recv7 = ttl.cb_reserve %cb7 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post7 = ttl.copy %pipe7, %recv7 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 7>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post7 : !ttl.transfer_handle
    %recv8 = ttl.cb_reserve %cb8 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post8 = ttl.copy %pipe8, %recv8 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 8>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post8 : !ttl.transfer_handle
    %recv9 = ttl.cb_reserve %cb9 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post9 = ttl.copy %pipe9, %recv9 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 9>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post9 : !ttl.transfer_handle
    %recv10 = ttl.cb_reserve %cb10 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post10 = ttl.copy %pipe10, %recv10 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 10>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post10 : !ttl.transfer_handle
    %recv11 = ttl.cb_reserve %cb11 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post11 = ttl.copy %pipe11, %recv11 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 11>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post11 : !ttl.transfer_handle
    %recv12 = ttl.cb_reserve %cb12 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post12 = ttl.copy %pipe12, %recv12 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 12>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post12 : !ttl.transfer_handle
    %recv13 = ttl.cb_reserve %cb13 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post13 = ttl.copy %pipe13, %recv13 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 13>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post13 : !ttl.transfer_handle
    %recv14 = ttl.cb_reserve %cb14 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post14 = ttl.copy %pipe14, %recv14 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 14>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post14 : !ttl.transfer_handle
    %recv15 = ttl.cb_reserve %cb15 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post15 = ttl.copy %pipe15, %recv15 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 15>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post15 : !ttl.transfer_handle
    %recv16 = ttl.cb_reserve %cb16 : <[1, 1], !ttcore.tile<32x32, f32>, 1> -> tensor<1x1x!ttcore.tile<32x32, f32>>
    %post16 = ttl.copy %pipe16, %recv16 : (!ttl.pipe<src(0, 0) dst(1, 0) to(1, 0) net 16>, tensor<1x1x!ttcore.tile<32x32, f32>>) -> !ttl.transfer_handle
    ttl.wait %post16 : !ttl.transfer_handle
    func.return
  }
}
