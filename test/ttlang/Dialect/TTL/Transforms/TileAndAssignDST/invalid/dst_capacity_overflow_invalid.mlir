...
// RUN: ttlang-opt %s -pass-pipeline='builtin.module(func.func(ttl-tile-and-assign-dst{dst-capacity=2}))' --split-input-file --verify-diagnostics
...
func.func @capacity_overflow(%a: tensor<2x2x!ttcore.tile<32x32, f32>>,
  ...
  ^bb0(%a_tile: !ttcore.tile<32x32, f32>,
    ...
    // Three live inputs exceed capacity=2 immediately.
