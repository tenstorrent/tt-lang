...
module attributes {ttl.launch_grid = [1, 1]} {
  func.func @missing_interface_preserved_access()
    ...
    // expected-error @below {{'ttl.bind_cb' op DFB allocation group #ttl.dfb_allocation_group<0> members=[0, 1] cannot alias logical DFBs 0 and 1: unproven-quiescence}}
...
// Interface preservation does not make concurrent storage access safe. The
// writer may begin waiting on the queue while compute uses the descriptor.
module attributes {ttl.launch_grid = [1, 1]} {
