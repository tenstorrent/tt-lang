...
// expected-error @below {{selected DFB and fixed-state allocation uses 2112 L1 bytes, exceeding the 2111-byte budget (DFB=2048, reset scratch=64, reconfiguration state=0)}}
module attributes {
  ttl.launch_grid = [1, 1],
