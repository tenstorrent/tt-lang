...
// CHECK-NEXT: ),
// CHECK-NEXT: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-allocation-strategy=first-fit-decreasing l1-budget-override=0 memory-model=metal-cb reuse-user-dfbs=true unsafe-assume-allocation-groups=false},
