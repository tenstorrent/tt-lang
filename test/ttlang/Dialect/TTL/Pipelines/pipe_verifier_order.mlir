...
// CHECK-NEXT: ),
// CHECK-NEXT: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-allocation-strategy=multi-order-decreasing l1-budget-override=0 memory-model=metal-cb reuse-user-dfbs=true sram-minimum-arena-search-limit=1000000 unsafe-assume-allocation-groups=false},
