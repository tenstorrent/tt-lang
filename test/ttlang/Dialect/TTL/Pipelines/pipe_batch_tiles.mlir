...
// RUN: ttlang-opt %s --ttl-to-ttkernel-pipeline='fabric-mux=false' --dump-pass-pipeline -o /dev/null 2>&1 | FileCheck %s --check-prefix=NO-MUX
...
// AUTO: convert-ttl-to-ttkernel{fabric-mux=true l1-budget-override=0
...
// BUDGET: convert-ttl-to-ttkernel{fabric-mux=true l1-budget-override=98304

// Disabling mux eligibility reaches the target-lowering pass.
// NO-MUX: convert-ttl-to-ttkernel{fabric-mux=false
