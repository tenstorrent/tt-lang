...
// AUTO: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-budget-override=0 memory-model=metal-cb reuse-user-dfbs=true unsafe-assume-allocation-groups=false}
...
// BOUND: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-budget-override=0 memory-model=metal-cb reuse-user-dfbs=true unsafe-assume-allocation-groups=false}
...
// BUDGET: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-budget-override=98304 memory-model=metal-cb reuse-user-dfbs=true unsafe-assume-allocation-groups=false}
...
// COMPILER-L1: ttl-finalize-dfb-indices{exact-coloring-search-limit=1000000 l1-budget-override=0 memory-model=compiler-l1 reuse-user-dfbs=true unsafe-assume-allocation-groups=false}
