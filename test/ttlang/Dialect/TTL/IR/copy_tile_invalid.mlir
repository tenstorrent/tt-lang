...
func.func @non_tile_src(%t: tensor<1xf32>, %idx: index) {
  ...
  %0, %1 = ttl.copy_tile %t[%idx] into dst[%idx] : tensor<1xf32> -> !ttl.dst, !ttcore.tile<32x32, f32>
  func.return
}
...
func.func @mismatched_result_type(%t: !ttcore.tile<32x32, f32>, %idx: index) {
  ...
  %0 = ttl.copy_tile %t[%idx] into dst[%idx] : !ttcore.tile<32x32, f32> -> !ttl.dst
  func.return
}
...
func.func @dst_tile_type_mismatch(%t: !ttcore.tile<32x32, f32>, %idx: index) {
  ...
  %0, %1 = ttl.copy_tile %t[%idx] into dst[%idx] : !ttcore.tile<32x32, f32> -> !ttl.dst, !ttcore.tile<32x32, bf16>
  func.return
}
