...
// Verify that one-word TTKernel tables become packed immediates while larger
// tables use bit-packed static C++ storage outside kernel_main.
...
// NUM-COUNT-1: static const uint64_t __ttlang_constant_table_
// CPP: #include <cstdint>
// CPP: static const uint64_t __ttlang_constant_table_{{[A-F0-9]+}}[2] = {0xC5A928398A418820ULL, 0x107B9AULL};
// CPP-LABEL: void kernel_main()
// CPP-NOT: size_t v{{[0-9]+}}[3];
// Values [3, 5, 8] require four bits each and pack into 0x853.
// CPP: experimental::constant_table_lookup_word<4>({{.*}}, 0x853ULL)
