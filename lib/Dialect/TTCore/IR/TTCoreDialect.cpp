...
#include "ttlang/Dialect/TTCore/IR/TTCoreOpsDialect.cpp.inc"

#define GET_ATTRDEF_CLASSES
#include "ttlang/Dialect/TTCore/IR/TTCoreOpsAttrDefs.cpp.inc"
...
void mlir::tt::ttcore::TTCoreDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "ttlang/Dialect/TTCore/IR/TTCoreOps.cpp.inc"
      >();
  // NOLINTNEXTLINE
  addAttributes<
