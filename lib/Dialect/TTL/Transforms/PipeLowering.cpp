...
static void coalesceUnserializedFabricRuntimeIntervals(
    FabricRoutePlan &plan) {
  // Every unserialized interval in a function uses the same host-specialized
  // connection records. Multiple managers would open the same records.
