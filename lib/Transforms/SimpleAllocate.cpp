...
#define GEN_PASS_DEF_TTLANGALLOCATE
...
class TTLangAllocate : public impl::TTLangAllocateBase<TTLangAllocate> {
public:
  using impl::TTLangAllocateBase<TTLangAllocate>::TTLangAllocateBase;
...
std::unique_ptr<Pass> createTTLangAllocate() {
  return std::make_unique<TTLangAllocate>();
}
