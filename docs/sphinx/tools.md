...
- `ninja -C build check-ttlang-all` runs the full compiler test suite (MLIR, bindings, packaging, end-to-end, pytest, Python lit). Does not include simulator tests.
