...
- `convert-ttl-to-ttkernel` - lower TTL data movement and PipeNet operations to TTKernel; select receiver-published or computed destination addressing and receiver-post or capacity-counter synchronization
