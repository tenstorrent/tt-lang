...
| Function | Description |
| :---- | :---- |
| `ttl.block.fill(value: float, shape: ttl.Shape, layout: ttnn.Layout = ttnn.TILE_LAYOUT, dtype: ttnn.DataType = ttnn.bfloat16) -> ttl.BlockExpr` | Fill a block of specified `shape` with specified `value` of specified `dtype`. |
