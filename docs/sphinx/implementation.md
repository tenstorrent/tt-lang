...
- [`ComputeOp` Creation and Fusion](https://github.com/tenstorrent/tt-lang/blob/main/docs/development/ComputeOpCreationAndFusion.md) - immutable planning for `ttl.compute` creation, multi-stage fusion, DFB publication, and target schedule selection
