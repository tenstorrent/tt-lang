...
- [Compute Formation and Fusion](https://github.com/tenstorrent/tt-lang/blob/main/docs/development/ComputeFormation.md) - immutable planning for tensor-to-tile formation, fusion, DFB publication, and intermediate materialization
