...
skips overlapping producer/pop-owner domain checks here and same-node producer
...
program must ensure that at most one producer and at most one pop owner controls
