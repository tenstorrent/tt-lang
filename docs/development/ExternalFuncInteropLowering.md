...
kind of summary
remains an opaque access until a synchronized reset proves completion. Without
that reset, its reuse contract is incomplete. A complete, accurate contract can
prove a bounded lifecycle and permit physical-index reuse.
