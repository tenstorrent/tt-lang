...
ttl.tile_store %placeholder, %view[0, 0] into dst[%c0] : ...
ttl.tile_store %placeholder, %view[0, 1] into dst[%c1] : ...
ttl.tile_store %placeholder, %view[1, 0] into dst[%c2] : ...
ttl.tile_store %placeholder, %view[1, 1] into dst[%c3] : ...
