...
# Remove unnecessary LLVM/MLIR binaries, replacing each with an empty executable stub.
# Keep: FileCheck, flatc, llvm-lit, *tblgen*, not, count, split-file (lit utilities)
...
stub llc lli lli-child-target opt bugpoint \
