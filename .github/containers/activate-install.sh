...
echo "   - Python simulator: tt-lang-sim $TTLANG_TOOLCHAIN_DIR/examples/elementwise-tutorial/step_4_multinode_grid_full.py"
echo "   - TT hardware:      python $TTLANG_TOOLCHAIN_DIR/examples/elementwise-tutorial/step_4_multinode_grid_full.py"
