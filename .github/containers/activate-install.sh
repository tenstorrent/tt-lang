...
export PYTHONPATH="${INSTALL_PREFIX}/python_packages:${TTLANG_TOOLCHAIN_DIR}/python_packages:$PYTHONPATH"
export LD_LIBRARY_PATH="${TTLANG_TOOLCHAIN_DIR}/lib:${TTLANG_TOOLCHAIN_DIR}/tt-metal/lib:${TTLANG_TOOLCHAIN_DIR}/tt-metal/tt_metal:${TTLANG_TOOLCHAIN_DIR}/tt-metal/ttnn:$LD_LIBRARY_PATH"
