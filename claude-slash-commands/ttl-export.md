...
~/.claude/commands/tools/run-test.sh --emit-runner /path/to.py  # Run + emit C++ kernels and Python runner
...
```bash
~/.claude/commands/tools/run-test.sh /path/to/kernel.py
```
...
```bash
~/.claude/commands/tools/run-test.sh --emit-runner /path/to/kernel.py
```
...
```bash
~/.claude/commands/tools/run-test.sh /path/to/my_kernel/run_kernel.py
```
...
3. Run `~/.claude/commands/tools/run-test.sh` on the exported kernel
