        ...
        for address_core_ranges, tensor_addresses in tensor_address_groups:
            ...
            for descriptor_variant in descriptor_variants:
                ...
                if sram_core_arenas:
                    ...
                    address = tensor_base(
                        ttnn, arena, coordinate, sram_mesh_coordinate
                    )
                    ...
                    kernel_descriptor_args["defines"] = list(
                        defines
                    ) + payload_defines(sram_configs, coordinate)
...
def _run_kernel_on_device_impl(
    ...
    def build_device_program(device_coordinates=None, mesh_coordinate=None):
        kernel_descriptors = build_kernel_descriptors(
            ...
            device_coordinates=device_coordinates,
            device_coordinate=mesh_coordinate,
    ...
    if device_domain is not None:
        ...
        if requires_device_specific_programs:
            program_descriptors = {
                mesh_coordinate: build_device_program(mesh_coordinate=mesh_coordinate)
