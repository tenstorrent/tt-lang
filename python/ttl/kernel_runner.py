...
def build_dfb_reconfiguration_runtime_resources(
    ...
    def scratch_allocation_order(item):
        ...
        return (-len(storage_nodes), -storage_bytes, storage_index)

    # Allocations spanning more nodes have fewer addresses that remain free in
    # every dependent per-core allocator. Place them before narrower storage.
