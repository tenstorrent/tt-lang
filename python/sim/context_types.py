...
class SimulatorContext:
    ...
    # Code-object identities whose wait_any calls retain incomplete requests.
    wait_any_cleanup_codes: Set[int] = field(default_factory=set)
    # Incomplete requests retained after wait_any selects another request.
    # Indexed by the identity of the executing Python frame.
    pending_wait_any_requests: Dict[int, list[Any]] = field(default_factory=dict)
