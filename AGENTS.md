...
- **Runtime tests**: `llvm-lit test/python/` (hardware execution tests, require `SYSTEM_DESC_PATH`)
...
- **Includes**: Absolute paths from tt-lang root, sorted: main header → local → LLVM → system
